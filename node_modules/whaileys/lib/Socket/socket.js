...
const makeSocket = ({ waWebSocketUrl, connectTimeoutMs, logger, agent, keepAliveIntervalMs, version, browser, auth: authState, printQRInTerminal, defaultQueryTimeoutMs, syncFullHistory, transactionOpts, qrTimeout, options }) => {
    ...
    const onMessageRecieved = (data) => {
        noise.decodeFrame(data, frame => {
            ...
            if (!(frame instanceof Uint8Array)) {
                ...
                const frameContent = (_a = frame === null || frame === void 0 ? void 0 : frame.content) === null || _a === void 0 ? void 0 : _a[0];
                if ((frameContent === null || frameContent === void 0 ? void 0 : frameContent.tag) === "offline_preview" &&
                    ((_b = frameContent === null || frameContent === void 0 ? void 0 : frameContent.attrs) === null || _b === void 0 ? void 0 : _b.count) > 100 &&
                    logger.level === "error") {
                    logger.error({
                        message: "offline_preview",
                        count: (_c = frameContent === null || frameContent === void 0 ? void 0 : frameContent.attrs) === null || _c === void 0 ? void 0 : _c.count
                    });
                }
                ...
                const l2 = Array.isArray(frame.content) ? (_d = frame.content[0]) === null || _d === void 0 ? void 0 : _d.tag : "";
                Object.keys(l1).forEach(key => {
                    anyTriggered =
                        ws.emit(`${Defaults_1.DEF_CALLBACK_PREFIX}${l0},${key}:${l1[key]},${l2}`, frame) || anyTriggered;
                    anyTriggered =
                        ws.emit(`${Defaults_1.DEF_CALLBACK_PREFIX}${l0},${key}:${l1[key]}`, frame) ||
                            anyTriggered;
                    anyTriggered =
    ...
    const requestPairingCode = async (phoneNumber, customPairingCode) => {
        ...
        if (customPairingCode && (customPairingCode === null || customPairingCode === void 0 ? void 0 : customPairingCode.length) !== 8) {
            throw new boom_1.Boom("Custom pairing code must be exactly 8 chars");
        }
    ...
    ws.on("error", error => end(new boom_1.Boom(`WebSocket Error (${error.message})`, {
