...
exports.aesDecryptCTR = exports.aesEncryptCTR = exports.derivePairingCodeKey = exports.hkdf = exports.sha256 = exports.hmacSign = exports.aesEncrypWithIV = exports.aesEncrypt = exports.aesDecryptWithIV = exports.aesDecrypt = exports.aesDecryptGCM = exports.aesEncryptGCM = exports.signedKeyPair = exports.Curve = exports.generateSignalPubKey = void 0;
...
// HKDF key expansion
const hkdf = (buffer, expandedLength, params) => {
    const key = Buffer.isBuffer(buffer) ? buffer : Buffer.from(buffer);
    const normalized = params.info && Buffer.isBuffer(params.info)
        ? { ...params, info: params.info.toString("latin1") }
        : params;
    return (0, futoin_hkdf_1.default)(key, expandedLength, normalized);
};
exports.hkdf = hkdf;
