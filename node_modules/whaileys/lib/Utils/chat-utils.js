...
const chatModificationToAppPatch = (mod, jid) => {
    ...
    if ("mute" in mod) {
        ...
        patch = {
            ...
            index: [Types_1.LabelAssociationType.Chat, mod.addChatLabel.labelId, jid],
            type: "regular",
            apiVersion: 3,
            operation: OP.SET
        };
        ...
        patch = {
            ...
            index: [Types_1.LabelAssociationType.Chat, mod.removeChatLabel.labelId, jid],
            type: "regular",
            apiVersion: 3,
            operation: OP.SET
        };
        ...
        patch = {
            ...
            index: [
                Types_1.LabelAssociationType.Message,
...
const processSyncAction = (syncAction, ev, me, initialSyncOpts, logger) => {
    ...
    if (action === null || action === void 0 ? void 0 : action.muteAction) {
        ...
        const type = syncAction.index[0];
        let association;
        if (type === Types_1.LabelAssociationType.Chat) {
            association = {
                type: Types_1.LabelAssociationType.Chat,
                labelId: syncAction.index[1],
                chatId: syncAction.index[2]
            };
        }
        else if (type === Types_1.LabelAssociationType.Message) {
            association = {
                type: Types_1.LabelAssociationType.Message,
                labelId: syncAction.index[1],
                chatId: syncAction.index[2],
