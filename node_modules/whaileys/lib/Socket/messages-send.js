...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, statusJidList }) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            if (!isRetryResend &&
                (0, reporting_utils_1.shouldIncludeReportingToken)(message) &&
                ((_f = message.messageContextInfo) === null || _f === void 0 ? void 0 : _f.messageSecret)) {
                const reportingKey = {
                    id: msgId,
                    fromMe: true,
                ...
                const reportingNode = await (0, reporting_utils_1.getMessageReportingToken)(encodedMsg, message, reportingKey).catch(err => {
