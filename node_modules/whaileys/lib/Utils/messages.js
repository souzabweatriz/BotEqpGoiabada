...
const prepareWAMessageMedia = async (message, options) => {
    ...
    const requiresWaveformProcessing = mediaType === "audio" &&
        uploadData.ptt === true &&
        uploadData.waveform === undefined;
    const { mediaKey, originalFilePath, encFilePath, fileEncSha256, fileSha256, fileLength } = await (0, messages_media_1.encryptedStream)(uploadData.media, options.mediaTypeOverride || mediaType, requiresDurationComputation || requiresWaveformProcessing, options.logger);
    ...
    if (requiresWaveformProcessing && originalFilePath) {
        ...
        if (uploadData.waveform) {
            logger === null || logger === void 0 ? void 0 : logger.debug("computed audio waveform");
        }
    }
    await fs_1.promises
        .unlink(encFilePath)
...
const generateWAMessageContent = async (message, options) => {
    ...
    if ((0, reporting_utils_1.shouldIncludeReportingToken)(m)) {
        ...
        if (!m.messageContextInfo.messageSecret) {
            m.messageContextInfo.messageSecret = (0, crypto_2.randomBytes)(32);
        }
    }
